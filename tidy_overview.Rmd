...
1. Install stuff 
  1. [Rstudio](rstudio.com) - `rstudio.com`
  2. the tidyverse with this R command: `install.packages("tidyverse")`
2. Get the slides and/or code if you'd like to follow along:
  - [github.com/andrewGhazi/tidy_overview](github.com/andrewGhazi/tidy_overview)
